      ...
      w3_div('w3-show-inline-block w3-width-full',
         ...
         w3_col_percent('w3-container w3-margin-T-8 w3-margin-B-16/',
            w3_divs('w3-center w3-tspace-8',
               w3_switch_label('w3-center', 'Update grid continuously<br>from GPS?', 'Yes', 'No', 'cfg.ft8.GPS_update_grid', cfg.ft8.GPS_update_grid, 'admin_radio_YN_cb'),
            ...
            '&nbsp;', 3,
            w3_divs('w3-center w3-tspace-8',
               w3_switch_label('w3-center', 'Log decodes to<br>syslog?', 'Yes', 'No', 'cfg.ft8.syslog', cfg.ft8.syslog, 'admin_radio_YN_cb'),
               w3_text('w3-text-black w3-center',
